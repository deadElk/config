...
const (
	...
	_Policy_Statement_Protocol_direct                _Policy_Statement_Protocol = "direct"
	_Policy_Statement_Protocol_aggregate             _Policy_Statement_Protocol = "aggregate"
	_Policy_Statement_Protocol_static                _Policy_Statement_Protocol = "static"
	_Policy_Statement_Protocol_local                 _Policy_Statement_Protocol = "local"
	_Policy_Statement_Protocol_access_internal       _Policy_Statement_Protocol = "access-internal"
	_Policy_Statement_Measure_exact                  _Policy_Statement_Measure  = "exact"
	_Policy_Statement_Measure_longer                 _Policy_Statement_Measure  = "longer"
	_Policy_Statement_Measure_orlonger               _Policy_Statement_Measure  = "orlonger"
	_Policy_Statement_Action_reject                  _Policy_Statement_Action   = "reject"
	_Policy_Statement_Action_next_policy             _Policy_Statement_Action   = "next policy"
	_Policy_Statement_Action_load_balance_per_packet _Policy_Statement_Action   = "load-balance per-packet"
)
