...
const (
	...
	_juniper_mgmt_Description _Descr   = "MANAGEMENT-INSTANCE"
	...
	_vi_lt                    _VI_Type = "lt"
	_default_vi                        = _vi_st
	_if_comm_ptp              _IF_Comm = "ptp"
	_if_comm_ptmp             _IF_Comm = "ptmp"
	...
	_protocol_all             _Proto   = "all"
	_protocol_bgp             _Proto   = "bgp"
