...
var (
	c_Action = map[_Action]_Action{
		_Action_ID:                       _Action_ID,
		_Action_accept:                   _Action_accept,
		_Action_add:                      _Action_add,
		_Action_address:                  _Action_address,
		_Action_all:                      _Action_all,
		_Action_deny:                     _Action_deny,
		_Action_deny_all:                 _Action_deny_all,
		_Action_destination:              _Action_destination,
		_Action_destination_address:      _Action_destination_address,
		_Action_destination_address_name: _Action_destination_address_name,
		_Action_destination_nat:          _Action_destination_nat,
		_Action_destination_prefix_list:  _Action_destination_prefix_list,
		_Action_discard:                  _Action_discard,
		_Action_exact:                    _Action_exact,
		_Action_export:                   _Action_export,
		_Action_filter:                   _Action_filter,
		_Action_firewall:                 _Action_firewall,
		_Action_fqdn:                     _Action_fqdn,
		_Action_from:                     _Action_from,
		_Action_fxp:                      _Action_fxp,
		_Action_global:                   _Action_global,
		_Action_gr:                       _Action_gr,
		_Action_group:                    _Action_group,
		_Action_hop:                      _Action_next_hop,
		_Action_host_inbound_traffic:     _Action_host_inbound_traffic,
		_Action_import:                   _Action_import,
		_Action_instance:                 _Action_instance,
		_Action_interface:                _Action_next_hop,
		_Action_ipprefix:                 _Action_ipprefix,
		_Action_link:                     _Action_link,
		_Action_list:                     _Action_list,
		_Action_lo:                       _Action_lo,
		_Action_load_balance:             _Action_load_balance,
		_Action_log:                      _Action_log,
		_Action_lt:                       _Action_lt,
		_Action_metric:                   _Action_metric,
		_Action_name:                     _Action_name,
		_Action_nat:                      _Action_nat,
		...
		_Action_policy_statement:         _Action_policy_statement,
		_Action_pool:                     _Action_pool,
		_Action_prefix:                   _Action_prefix,
		_Action_prefix_list:              _Action_prefix_list,
		_Action_prefix_list_filter:       _Action_prefix_list_filter,
		_Action_prefix_name:              _Action_prefix_name,
		_Action_protocol:                 _Action_protocol,
		_Action_qnh:                      _Action_qualified_next_hop,
		_Action_qualified_next_hop:       _Action_qualified_next_hop,
		_Action_reject:                   _Action_reject,
		_Action_route:                    _Action_route,
		_Action_route_type:               _Action_route_type,
		_Action_routing:                  _Action_routing,
		_Action_routing_group:            _Action_routing_group,
		_Action_routing_instance:         _Action_routing_instance,
		_Action_security:                 _Action_security,
		_Action_security_policy:          _Action_security_policy,
		_Action_security_zone:            _Action_security_zone,
		_Action_self:                     _Action_self,
		_Action_set:                      _Action_set,
		_Action_source:                   _Action_source,
		_Action_source_address:           _Action_source_address,
		_Action_source_address_name:      _Action_source_address_name,
		_Action_source_nat:               _Action_source_nat,
		_Action_source_prefix_list:       _Action_source_prefix_list,
		_Action_st:                       _Action_st,
		_Action_statement:                _Action_statement,
		_Action_static:                   _Action_static,
		_Action_static_nat:               _Action_static_nat,
		_Action_table:                    _Action_next_table,
		_Action_then:                     _Action_then,
		_Action_to:                       _Action_to,
		_Action_type:                     _Action_type,
		_Action_vi:                       _Action_vi,
		_Action_zone:                     _Action_zone,
	}
