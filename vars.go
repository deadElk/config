...
var (
	...
	c_Type = map[_Type]_Type{
		...
		_Type_destination_prefix_list: _Type_destination_prefix_list,
		...
		_Type_prefix_prefix_list:      _Type_prefix_prefix_list,
		...
		_Type_source_prefix_list:      _Type_source_prefix_list,
		_Type_st:                      _Type_st,
